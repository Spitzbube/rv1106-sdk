...
# Kernel dts
export RK_KERNEL_DTS=rv1106g-evb1-v11-dual-cam.dts
...
export RK_CAMERA_SENSOR_IQFILES="sc4336_OT01_40IRC_F16.bin os04a10_CMK-OT1607-PV1_50IRC-F16.bin gc2053_CMK-OT2274-V10_28IRC-F20.bin"
...
export RK_BOOTARGS_CMA_SIZE="62M"
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),1M(uboot),8M(boot),32M(rootfs),32M(oem),32M(userdata)"
